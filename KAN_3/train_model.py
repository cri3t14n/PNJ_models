...
print(normalized_data_example)  # This prints values in [0, 1]
# ========================================================================================================
...
#     sample_plot_path = os.path.join(results_folder, f"train_sample_{i}_comparison.png")
...
for i in range(num_test_samples):
    ...
    sample_plot_path = os.path.join(results_folder, f"test_sample_{i}_comparison.png")
    plt.savefig(sample_plot_path)
